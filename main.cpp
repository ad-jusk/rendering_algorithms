...
int main() {
    ...
    model = Matrix4::Translation(0.f, 1.3f, 0.f) *
            Matrix4::RotationZ(ToRad(180.f)) *
            Matrix4::RotationX(ToRad(30)) *
